...
const Ic = {
  ...
  steth: <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="5.5" cy="17" r="3"/><path d="M8 17Q17 17 17 10V6"/><circle cx="17" cy="4" r="2"/></svg>,
